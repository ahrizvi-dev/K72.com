    ...
    <div className="text-white font-[font300] text-center">
      ...
      <div className=" flex justify-end pr-4 mt-8">
        <h3 className="w-[60vw] md:w-[15vw] text-start font-[font300] ">
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;This practice
          website is built to explore creativity through animation. Not just for
          today, but as a skill that grows tomorrow, in five months, and in five
          years. We look for the spark that turns simple practice into
          inspiration.
        </h3>
      </div>
    </div>
